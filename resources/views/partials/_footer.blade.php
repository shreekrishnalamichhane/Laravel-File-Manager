    ...
    <div class="">
        <div class="container">
            <div class="d-md-flex justify-content-between pt-4">
                <div class="pb-4 fs-xs text-muted text-center text-md-start">© All rights reserved. By <a
                        class="text-muted" href="#">Shree Krishna Lamichhane</a></div>
                <div class="widget widget-links pb-4">
                    <ul class="widget-list d-flex flex-wrap justify-content-center justify-content-md-start">
                        <li class="widget-list-item ms-4"><a class="widget-list-link fs-ms" href="#" target="_blank">Our
                                Website</a>
                        </li>
                        <li class="widget-list-item ms-4"><a class="widget-list-link fs-ms" href="#"
